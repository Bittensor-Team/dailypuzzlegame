...
(function () {
  ...
  /* The map lives in worldmap.js so the battle page draws the very same one. */
  var earth = window.DCPMap || { start: function () {}, refresh: function () {} };

  /* ------------------------------------------------------------------ */
  /* Celebration                                                         */
  /* ------------------------------------------------------------------ */

  /* Fireworks live in fx.js so the battle page runs the very same code. */
  ...
  function start(date, dealt) {
    ...
    // Badges live in fx.js so the battle leaderboard shows the very same ones.
